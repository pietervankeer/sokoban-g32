...
public class UC8Applicatie {
	// properties
	private final DomeinController dc;
	private Scanner input;
		
	// constuctor
	public UC8Applicatie(DomeinController dc) {
		this.dc = dc;
	...
	public void maakSpelbord() {
		...
		do {
			...
			if (dc.valideerSpelbord()) {
				dc.wijzigSpelbord();
				System.out.println(Taal.getVertaling("succesvolGewijzigd"));
	...
	private boolean vraagVerwijderen() {
		...
		do {
			try {
				System.out.println(Taal.getVertaling("spelbordAanpassenOfOngedaanMaken"));
